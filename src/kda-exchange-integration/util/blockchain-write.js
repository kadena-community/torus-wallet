...
var { getAcctDetails } = require("./blockchain-read.js");
var {
  pollTxRes,
  sleepPromise,
  makePactContCommand,
...
var { checkKey, formatAmount } = require("./format-helpers.js");
...
const transfer = async (
  ...
  try {
    ...
    if (pollRes.result.status === "success") {
      return swal(
        `TRANSFER SUCCESS: from ${fromAcct} to ${toAcct} for ${amount} ${tokenAddress} on chain ${chainId}`
      );
    } else {
