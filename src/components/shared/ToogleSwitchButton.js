...
const ToggleSwitchButton = ({ label1, label2, onChange, containerStyle, disabled, background }) => {
  ...
  return (
    <ButtonsContainer style={containerStyle}>
      <Button
        ...
        buttonStyle={networkContext.network.label  !== label1 ? { borderTopLeftRadius: 20, borderBottomLeftRadius: 20, width: "50%", margin: "0px" } : selectedStyle}
        border= "transparent"
        onClick={() => {
      ...
      <Button
        ...
        buttonStyle={
          networkContext.network.label  !== label2
            ? { borderTopRightRadius: 20, borderBottomRightRadius: 20, width: "50%", margin: "0px"}
            : selectedStyle
        }
